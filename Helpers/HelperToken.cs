...
namespace ClienteTienda.Helpers
{
    public class HelperToken
    {
        ...
        {
            this.Issuer = configuration["ApiTienda:Issuer"];
            this.Audience = configuration["ApiTienda:Audience"];
            this.SecretKey = configuration["ApiTienda:SecretKey"];
        }
